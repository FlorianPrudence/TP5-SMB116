package cnam.smb116.tp5.DBHelpers;
...
public class EnseignantsHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATION_DB = "CREATE TABLE " + TABLE_ENSEIGNANTS + " (" +
    ...
    private static final String DROP_DB = "DROP TABLE IF EXISTS " + TABLE_ENSEIGNANTS + ";";
